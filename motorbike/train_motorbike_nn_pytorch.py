"""
PyTorch Training Script for MotorBike Neural Network
...
def plot_predictions(y_true, y_pred, output_names=['Cd', 'Cl', 'Cm'],
                    save_path='prediction_results_pytorch.png'):
...
def main():
    ...
    print("=" * 70)
    print("MotorBike CFD Neural Network Training (PyTorch)")
    print("=" * 70)
    ...
    print("\n[5] Compiling model...")
    nn.compile_model(learning_rate=0.001, optimizer_type='adam', weight_decay=0.001)
    ...
    # Plot results
    print("\n[10] Generating plots...")
    nn.plot_training_history('training_history_pytorch.png')
    plot_predictions(y_test_denorm, y_pred, output_names, 'prediction_results_pytorch.png')

    # Save model
    print("\n[11] Saving model...")
    nn.save_model('motorbike_nn_final_pytorch.pth')

    # Save normalization parameters (reuse same format)
    np.savez('normalization_params_pytorch.npz',
            X_mean=X_mean, X_std=X_std,
            y_mean=y_mean, y_std=y_std)
    print("Normalization parameters saved to normalization_params_pytorch.npz")

    print("\n" + "=" * 70)
    print("Training Complete!")
    print("=" * 70)
    print("\nGenerated files:")
    print("  - motorbike_nn_final_pytorch.pth (trained model)")
    print("  - best_motorbike_model_pytorch.pth (best checkpoint)")
    print("  - training_history_pytorch.png (training curves)")
    print("  - prediction_results_pytorch.png (prediction scatter plots)")
    print("  - normalization_params_pytorch.npz (normalization parameters)")

    return nn, processor, (test_loss, test_mae)
...
if __name__ == "__main__":
    ...
    print("\n" + "=" * 70)
    print("You can now use the trained PyTorch model for predictions!")
    print("=" * 70)
